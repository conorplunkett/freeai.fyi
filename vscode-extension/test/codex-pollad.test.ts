...
// __FREEAI_AD__ was frozen for the life of the webview — rotation re-patched
...
function preparedAsset(): string {
  const subs: Record<string, string> = {
    ...
    __FREEAI_CORR__: JSON.stringify("test.codex.poll"),
...
const overlayOf = (doc: Document) =>
  doc.querySelector('[data-freeai="codex"]');
const anchorOf = (doc: Document) =>
  doc.querySelector('[data-freeai="codex"] a[data-freeai-ad]') as
